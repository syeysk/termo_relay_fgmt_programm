...
//    //{ if (TCNT0 >= 60) return 13; }
//    for (int i = 0; i < 200; i++) {
//    	if (!IS_SET(DHT_PORT_IN,DHT_PIN)) break;
//    	//_delay_ms(1);
//    } if (IS_SET(DHT_PORT_IN,DHT_PIN)) return 15;
//
//    /************************* Sensor preamble *************************/
//
//    //TCNT0 = 0;
...
//    	if (IS_SET(DHT_PORT_IN,DHT_PIN)) break;
//    	//_delay_ms(1);
//    } if (!IS_SET(DHT_PORT_IN,DHT_PIN)) return 16;
//
...
//    	if (!IS_SET(DHT_PORT_IN,DHT_PIN)) break;
//    	//_delay_ms(1);
//    } if (!IS_SET(DHT_PORT_IN,DHT_PIN)) return 17;
